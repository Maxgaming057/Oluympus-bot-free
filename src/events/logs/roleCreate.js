...
module.exports = {
    ...
    async execute(role) {
        ...
        const importedConfig = data.Logs.RoleCreate
        const logChannel = await foundChannel(role.guild, Utility.clientConfig.Logs.RoleCreate.channel);
        
        if(Utility.clientConfig.Logs.RoleCreate.enabled == false) return;
