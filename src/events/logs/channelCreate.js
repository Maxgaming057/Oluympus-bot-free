...
module.exports = {
    ...
    async execute(channel) {
        ...
        const importedConfig = data.Logs.ChannelCreate
        const logChannel = await foundChannel(channel.guild, Utility.clientConfig.Logs.ChannelCreate.channel);
        
        if(Utility.clientConfig.Logs.ChannelCreate.enabled == false) return;
